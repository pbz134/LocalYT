...
CHANNEL_FOLDERS = ['videos', 'subtitles', 'livechats', 'playlist-descriptions', 'channelposts', 'thumbnails', 'thumbnails-small', 'videolengths', 'videostats', 'viewcounts', 'descriptions', 'filedates', 'filenames', 'comments', 'channeldesc', 'channelstats', 'channel-home-meta-cache', 'channel-home-previews']
CHANNEL_FILES = ['channelbanner', 'channelpic', 'subcount']
MEDIA_EXTENSIONS = ('.mp4', '.mp3', '.mkv')
JSON_FILES = ['users.json', 'userPreferences.json', 'userCommentLikes.json', 'userSearchHistory.json', 'userSettings.json', 'subscriptions.json', 'watchHistory.json', 'likes.json', 'dislikes.json', 'recommendation_index.json', 'video_cache.json', 'login_attempts.json', 'playlist_cache.json']
...
def clear_database():
    ...
    for j_file in JSON_FILES:
        try:
            ...
            with open(j_path, 'w', encoding='utf-8') as f:
                if j_file in ['users.json', 'userPreferences.json', 'userCommentLikes.json', 'userSearchHistory.json', 'userSettings.json', 'subscriptions.json', 'recommendation_index.json']:
                    json.dump({}, f)
